...
def extrair_infos(lista_links):
    ...
    for link in lista_links:
        ...
        lista_noticias = pagina.find("div", attrs={"id":"content-core"})
        #find_all("article")
...
def inserir_bd(titulo, link, data, horario,data_atualizada, horario_atualizado,paragrafos):
    ...
    bd = TinyDB ("exame_brasil.json", indent=4, ensure_ascii=False)
    buscar = Query()
...
def main():
    url_base = "https://exame.com/brasil/ultimas-noticias/"
